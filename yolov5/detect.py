...
def run(
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            detection_counts_current_frame = {}
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    cls_index = int(cls)
                    detection_counts_current_frame[cls_index] = detection_counts_current_frame.get(cls_index, 0) + 1
            ...
            cd.accumulate_stats(detection_counts_current_frame)

            # Stream results
            im0 = annotator.result()
            cd.add(names, detected, save_dir, im0, detection_counts_current_frame)
            if view_img:
